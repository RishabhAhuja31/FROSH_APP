...
class _FAQPageState extends State<FAQPage> {
  ...
  Ques: Would all the hostels provide mattresses?
    Ans: Students allotted Non-AC rooms (except J-4s and H-4sand a-2s) hostels have to arrange for their own mattresses.Other than that,rest of the hostels provide mattresses.
