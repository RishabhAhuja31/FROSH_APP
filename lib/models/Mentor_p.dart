...
final List<Models> snk17Models = [
  ...
  Models(
    ...
    model: "Ahuja",
    branch: "COE",
    imgAddress: "https://i.imgur.com/OFlDzHD.jpg",
    modelColor: Color(0xffDE0106),
  ),
];
final List<Models> snk19Models = [
...
final List<Models> snk21Models = [
  ...
  Models(
    ...
    model: "Shubham",
    branch: "ECE",
    imgAddress: "https://i.imgur.com/64hJd2T.jpg",
    modelColor: Color(0xffDE0106),
  ),
  Models(
    name: "Vidish",
